...
<div class="row">
  <div class="col-sm-2"><h4 align="right">Hakusana: </h4></div>
  <div class="col-sm-3"><input type="text" name="hakusana" id="hakusana" class="form-control"></div>
  <div class="col-sm-1"><input type="submit" value="Hae" class="btn btn-primary"></div>
